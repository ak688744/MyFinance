 ...
 *
 * Verbatim port of src/features/investment/navService.ts. This is already a
 * pure module-level fetch client (no RN/expo specifics); Node 20 provides
 * global `fetch` natively. Cache, TTL, BASE_URL, and all DD-MM-YYYY date
 * parsing are preserved exactly.
 */
